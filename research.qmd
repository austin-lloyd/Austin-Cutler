...
-   Affective Policy Preferences: Does Group Affect Shape Policy Positions?

    [Using ANES panel data and Random-Intercept Cross Lagged Panel Models, I try to improve our understanding of the relationship between affective polarization and public opinion. Acriss a wide range of policies, I generally find little to no evidence of a meaningful relationship between affective polarization and policy opinions. These findings are counter to widely held theoretical expectations, but corroborate other recent findings suggesting that the impact of affective polarization may not be as far reaching as previously thought.]{style="color:gray"} [Link to paper.](https://www.dropbox.com/scl/fi/uq4sh5fcofhofanpjtygs/cutler_affective_polarization_policy.pdf?rlkey=g7c68remvejjzjhvdu67p72uk&st=p9c7nk8r&dl=0)

------------------------------------------------------------------------

-   Merely Asking A Replication of Ahler and Sood (2018) (*Conditionally Accepted at JOP*, with Matthew T. Pietryka and Carlisle Rainey)

    [Since Ahler and Sood (2018) was originally published, a growing literature has found that correcting people's misperceptions about the out-party reduces affective polarization. However, as noted by Ahler and Sood, "merely asking" respondents to report thier perceptions, also leads to a statistically significant reduction in out-party animosity. This result has been largely ignored in subsequent research. In this preregistered report, we propose a replication of Ahler and Sood's most important result using a well-powered, pre-registered survey experiment.]{style="color:gray"} [Link to paper.](https://www.dropbox.com/scl/fi/cldf7etwj4d8d1nfkx3kl/cutler_pietryka_rainey_merely_asking.pdf?rlkey=iztyo4d92z841qbjlvezky6un&st=2rzv98ii&dl=0)
...
## Select Conference Posters/Slides
